...
Функция СформироватьДеталиТТН(ДанныеJSON, Заголовок, СвязанныеДокументы = Неопределено) Экспорт
	...
	HTML = HTML + "<div class=""header""><div>"
		...
		+ "<div class=""header-sub"">" + Экр(КодТоплива) + " &middot; &rho;="
	...
	HTML = HTML + "<div class=""section"">Данные ТТН</div>"
		...
		+ "<tr><td>Топливо</td><td><b>" + Экр(КодТоплива) + "</b></td></tr>"
	...
	HTML = HTML + "<div class=""doc-row checked"">"
		...
		+ "<div class=""doc-detail"">Дт 41.01 Кт 60.01 &middot; " + Экр(КодТоплива) + "(т) "
	...
	HTML = HTML + "<div class=""doc-row checked"">"
		...
		+ Экр(КодТоплива) + "(т) " + Формат(МассаТонн, "ЧДЦ=3") + " т</div>"
		+ "<div class=""doc-amount"">" + Формат(МассаТонн, "ЧДЦ=3") + " т</div></div>";
	...
	HTML = HTML + "<div class=""doc-row checked"">"
		...
		+ "<div class=""doc-detail"">Дт 41.02 Кт 41.01 &middot; " + Экр(КодТоплива) + "(т) "
		+ Формат(МассаТонн, "ЧДЦ=3") + " т &rarr; " + Экр(КодТоплива) + " (л) "
